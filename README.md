...
- Expand JUnit coverage for edge cases and complete playthroughs.
- Add screenshots and a short gameplay GIF.
- Add undo support by extending the Command pattern.
- Add a level loader from JSON or text files.
- Add CI with GitHub Actions to compile and test the project automatically.
